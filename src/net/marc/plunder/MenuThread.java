...
public class MenuThread extends Thread
{
	...
	public MenuThread(SurfaceHolder surfaceHolder, MenuScreen menuScreen)
	{
		super();
		...
		while (running)
		{
			...
			try
			{
				...
				synchronized (surfaceHolder)
				{
					...
					if (running){this.menuScreen.render(canvas);}
	...
	private void storeStats()
	{
		...
		if (statusIntervalTimer >= lastStatusStore + STAT_INTERVAL)
		{
			...
			menuScreen.setAvgFps("FPS: " + df.format(averageFps));
		}
	}
